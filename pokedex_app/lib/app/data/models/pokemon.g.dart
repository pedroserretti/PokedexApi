...
_$AbilityEffectChangeImpl _$$AbilityEffectChangeImplFromJson(
        Map<String, dynamic> json) =>
    _$AbilityEffectChangeImpl(
      (json['effectEntries'] as List<dynamic>)
...
Map<String, dynamic> _$$AbilityEffectChangeImplToJson(
        _$AbilityEffectChangeImpl instance) =>
    <String, dynamic>{
      'effectEntries': instance.effectEntries,
      'versionGroup': instance.versionGroup,
    };

_$AbilityFlavorTextImpl _$$AbilityFlavorTextImplFromJson(
        Map<String, dynamic> json) =>
    _$AbilityFlavorTextImpl(
      json['flavorText'] as String,
      NamedAPIResource.fromJson(json['language'] as Map<String, dynamic>),
      NamedAPIResource.fromJson(json['versionGroup'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$AbilityFlavorTextImplToJson(
        _$AbilityFlavorTextImpl instance) =>
    <String, dynamic>{
...
_$AbilityPokemonImpl _$$AbilityPokemonImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$AbilityPokemonImplToJson(
        _$AbilityPokemonImpl instance) =>
    <String, dynamic>{
...
_$CharacteristicImpl _$$CharacteristicImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CharacteristicImplToJson(
        _$CharacteristicImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$GenderImpl _$$GenderImplFromJson(Map<String, dynamic> json) => _$GenderImpl(
      json['id'] as int,
      json['name'] as String,
      (json['pokemonSpeciesDetails'] as List<dynamic>)
          .map((e) => PokemonSpeciesGender.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['requiredForEvolution'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
_$PokemonSpeciesGenderImpl _$$PokemonSpeciesGenderImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PokemonSpeciesGenderImplToJson(
        _$PokemonSpeciesGenderImpl instance) =>
    <String, dynamic>{
      'rate': instance.rate,
      'pokemonSpecies': instance.pokemonSpecies,
    };
...
_$GrowthRateExperienceLevelImpl _$$GrowthRateExperienceLevelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$GrowthRateExperienceLevelImplToJson(
        _$GrowthRateExperienceLevelImpl instance) =>
    <String, dynamic>{
...
_$NatureImpl _$$NatureImplFromJson(Map<String, dynamic> json) => _$NatureImpl(
      json['id'] as int,
      json['name'] as String,
      json['decreasedStat'] == null
          ? null
          : NamedAPIResource.fromJson(
              json['decreasedStat'] as Map<String, dynamic>),
      json['increasedStat'] == null
          ? null
          : NamedAPIResource.fromJson(
              json['increasedStat'] as Map<String, dynamic>),
      json['hatesFlavor'] == null
          ? null
          : NamedAPIResource.fromJson(
              json['hatesFlavor'] as Map<String, dynamic>),
      json['likesFlavor'] == null
          ? null
          : NamedAPIResource.fromJson(
              json['likesFlavor'] as Map<String, dynamic>),
      (json['pokeathlonStatChanges'] as List<dynamic>)
          .map((e) => NatureStatChange.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['moveBattleStylePreferences'] as List<dynamic>)
          .map((e) =>
...
_$MoveBattleStylePreferenceImpl _$$MoveBattleStylePreferenceImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$MoveBattleStylePreferenceImplToJson(
        _$MoveBattleStylePreferenceImpl instance) =>
    <String, dynamic>{
...
_$NaturePokeathlonStatAffectSetsImpl
    _$$NaturePokeathlonStatAffectSetsImplFromJson(Map<String, dynamic> json) =>
        _$NaturePokeathlonStatAffectSetsImpl(
          (json['increase'] as List<dynamic>)
              .map((e) => NaturePokeathlonStatAffect.fromJson(
...
Map<String, dynamic> _$$NaturePokeathlonStatAffectSetsImplToJson(
        _$NaturePokeathlonStatAffectSetsImpl instance) =>
    <String, dynamic>{
      'increase': instance.increase,
      'decrease': instance.decrease,
    };

_$NaturePokeathlonStatAffectImpl _$$NaturePokeathlonStatAffectImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$NaturePokeathlonStatAffectImplToJson(
        _$NaturePokeathlonStatAffectImpl instance) =>
    <String, dynamic>{
      'maxChange': instance.maxChange,
...
_$PokemonFormTypeImpl _$$PokemonFormTypeImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PokemonFormTypeImplToJson(
        _$PokemonFormTypeImpl instance) =>
    <String, dynamic>{
      'slot': instance.slot,
      'type': instance.type,
    };

_$PokemonTypePastImpl _$$PokemonTypePastImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PokemonTypePastImplToJson(
        _$PokemonTypePastImpl instance) =>
    <String, dynamic>{
      'generation': instance.generation,
      'types': instance.types,
    };
...
_$PokemonMoveImpl _$$PokemonMoveImplFromJson(Map<String, dynamic> json) =>
    _$PokemonMoveImpl(
      ...
      (json['versionGroupDetails'] as List<dynamic>)
...
_$PokemonLocationAreasImpl _$$PokemonLocationAreasImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PokemonLocationAreasImplToJson(
        _$PokemonLocationAreasImpl instance) =>
    <String, dynamic>{
      'locationArea': instance.locationArea,
      'versionDetails': instance.versionDetails,
    };

_$PokemonColorImpl _$$PokemonColorImplFromJson(Map<String, dynamic> json) =>
    _$PokemonColorImpl(
      json['id'] as int,
      json['name'] as String,
      (json['names'] as List<dynamic>)
...
Map<String, dynamic> _$$PokemonColorImplToJson(_$PokemonColorImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'names': instance.names,
...
_$PokemonFormImpl _$$PokemonFormImplFromJson(Map<String, dynamic> json) =>
    _$PokemonFormImpl(
      ...
      (json['names'] as List<dynamic>)
          .map((e) => Name.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['formNames'] as List<dynamic>)
          .map((e) => Name.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
_$PokemonFormSpritesImpl _$$PokemonFormSpritesImplFromJson(
        Map<String, dynamic> json) =>
    _$PokemonFormSpritesImpl(
      json['frontDefault'] as String?,
      json['frontShiny'] as String?,
      json['backDefault'] as String?,
      json['backShiny'] as String?,
...
Map<String, dynamic> _$$PokemonFormSpritesImplToJson(
        _$PokemonFormSpritesImpl instance) =>
    <String, dynamic>{
      'frontDefault': instance.frontDefault,
      'frontShiny': instance.frontShiny,
      'backDefault': instance.backDefault,
...
_$PokemonShapeImpl _$$PokemonShapeImplFromJson(Map<String, dynamic> json) =>
    _$PokemonShapeImpl(
      json['id'] as int,
      json['name'] as String,
      (json['awesomeNames'] as List<dynamic>)
...
Map<String, dynamic> _$$PokemonShapeImplToJson(_$PokemonShapeImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
_$AwesomeNameImpl _$$AwesomeNameImplFromJson(Map<String, dynamic> json) =>
    _$AwesomeNameImpl(
      json['awesomeName'] as String,
      NamedAPIResource.fromJson(json['language'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$AwesomeNameImplToJson(_$AwesomeNameImpl instance) =>
    <String, dynamic>{
...
_$PokemonSpeciesImpl _$$PokemonSpeciesImplFromJson(Map<String, dynamic> json) =>
    _$PokemonSpeciesImpl(
      ...
      (json['pokedexNumbers'] as List<dynamic>)
          .map(
              (e) => PokemonSpeciesDexEntry.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['eggGroups'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      json['evolvesFromSpecies'] == null
          ? null
          : NamedAPIResource.fromJson(
              json['evolvesFromSpecies'] as Map<String, dynamic>),
      json['evolutionChain'] == null
          ? null
...
_$MoveStatAffectSetsImpl _$$MoveStatAffectSetsImplFromJson(
        Map<String, dynamic> json) =>
    _$MoveStatAffectSetsImpl(
      (json['increase'] as List<dynamic>)
...
Map<String, dynamic> _$$MoveStatAffectSetsImplToJson(
        _$MoveStatAffectSetsImpl instance) =>
    <String, dynamic>{
      'increase': instance.increase,
      'decrease': instance.decrease,
    };

_$MoveStatAffectImpl _$$MoveStatAffectImplFromJson(Map<String, dynamic> json) =>
    _$MoveStatAffectImpl(
      json['change'] as int,
      NamedAPIResource.fromJson(json['move'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$MoveStatAffectImplToJson(
        _$MoveStatAffectImpl instance) =>
    <String, dynamic>{
      'change': instance.change,
      'move': instance.move,
    };

_$NatureStatAffectSetsImpl _$$NatureStatAffectSetsImplFromJson(
        Map<String, dynamic> json) =>
    _$NatureStatAffectSetsImpl(
      (json['increase'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['decrease'] as List<dynamic>)
...
Map<String, dynamic> _$$NatureStatAffectSetsImplToJson(
        _$NatureStatAffectSetsImpl instance) =>
    <String, dynamic>{
      'increase': instance.increase,
      'decrease': instance.decrease,
    };
...
_$TypeImpl _$$TypeImplFromJson(Map<String, dynamic> json) => _$TypeImpl(
      ...
      (json['pastDamageRelations'] as List<dynamic>)
...
_$TypeRelationsImpl _$$TypeRelationsImplFromJson(Map<String, dynamic> json) =>
    _$TypeRelationsImpl(
      (json['noDamageTo'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['halfDamageTo'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['doubleDamageTo'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['noDamageFrom'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['halfDamageFrom'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['doubleDamageFrom'] as List<dynamic>)
          .map((e) => NamedAPIResource.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$TypeRelationsImplToJson(_$TypeRelationsImpl instance) =>
    <String, dynamic>{
...
_$TypeRelationsPastImpl _$$TypeRelationsPastImplFromJson(
        Map<String, dynamic> json) =>
    _$TypeRelationsPastImpl(
      NamedAPIResource.fromJson(json['generation'] as Map<String, dynamic>),
      TypeRelations.fromJson(json['damageRelations'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$TypeRelationsPastImplToJson(
        _$TypeRelationsPastImpl instance) =>
    <String, dynamic>{
      'generation': instance.generation,
      'damageRelations': instance.damageRelations,
    };
