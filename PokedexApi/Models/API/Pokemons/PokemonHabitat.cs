...
namespace PokedexApi.Models.API.Pokemons
{
    ...
    [DataContract]
    public class PokemonHabitat(int id, string name, List<Names> names, List<NamedApiResource<PokemonSpecies>> pokemonSpecies) : NamedApiResource
    {
        ...
        [JsonConstructor]
        public PokemonHabitat() : this(0, null!, null!, null!) { }
        ...
        public static PokemonHabitat Deserialize(string strAppData)
        {
            JsonSerializerSettings settingsJson = new() { DefaultValueHandling = DefaultValueHandling.Populate };
            return JsonConvert.DeserializeObject<PokemonHabitat>(strAppData, settingsJson)!;
        }
    }
}
